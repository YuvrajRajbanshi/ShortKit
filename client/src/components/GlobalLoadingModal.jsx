    ...
    <div className='fixed inset-0 bg-black/50 backdrop-blur-sm z-[9999] flex items-center justify-center'>
      ...
      <div className='bg-white rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col items-center justify-center gap-6 max-w-sm w-full mx-4'>
        ...
        <div className='relative w-20 h-20'>
          ...
          {/* Middle Ring */}
          <div className='absolute inset-2 border-4 border-transparent border-b-green-500 border-l-green-400 rounded-full animate-spin-reverse' style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
        ...
        <div className='text-center'>
          ...
          <p className='text-gray-600 text-sm md:text-base'>Please wait a moment</p>
        </div>
